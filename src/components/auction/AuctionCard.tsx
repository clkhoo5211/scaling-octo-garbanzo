...
export function AuctionCard({ auction, onBid, txHash }: AuctionCardProps) {
  ...
  const endTime = auction.end_time || auction.endTime || new Date().toISOString();
  const currentBid = auction.current_bid || parseFloat(String(auction.currentBid || '0'));
  ...
  const minBidIncrement = auction.min_bid_increment || 0.05;
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-medium">{isEnded ? 'Ended' : timeRemaining}</div>
