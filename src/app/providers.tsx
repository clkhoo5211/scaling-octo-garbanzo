 ...
 * AppKitProvider automatically uses the appKit instance created in context/index.tsx
 */
export function Providers({ children }: { children: ReactNode }) {
  ...
  // AppKitProvider will automatically use the appKit instance from context/index.tsx
  return (
