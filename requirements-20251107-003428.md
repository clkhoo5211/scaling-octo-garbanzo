...
- ✅ Content extraction working (@mozilla/readability)
- ✅ Font size adjustable
- ✅ Dark mode optimized
- ✅ Reading progress displayed
...
- ✅ Share to social media functional
- ✅ Referral tracking working (UTM parameters)
- ✅ Points awarded for sharing (5 points)
...
**Acceptance Criteria:**
- ✅ Create lists functional (public/private)
- ✅ Add articles to lists working
- ✅ Subscribe to lists working
- ✅ Points awarded (100 points for creating list)
...
- ✅ Like articles working (10 points awarded)
- ✅ Direct messages working (Supabase Realtime)
- ✅ Message notifications working (Web Push API)
- ✅ Following feed functional
...
**Acceptance Criteria:**
- ✅ Proposal creation working (costs 1,000 points)
- ✅ Voting functional (meritocratic power)
- ✅ Proposal execution working (51% + 10% quorum)
...
- ✅ Toggle original/translated view working
...
**Acceptance Criteria:**
- ✅ Summarization working (3 sentences)
- ✅ Summary cached (no repeat API calls)
- ✅ Premium feature enforced (unlimited summaries)
...
**Acceptance Criteria:**
- ✅ YouTube videos aggregating
- ✅ Video player embedded
- ✅ Video content tabs functional
...
**Acceptance Criteria:**
- ✅ Podcast RSS feeds parsing
- ✅ Audio player functional
- ✅ Podcast content tabs working
...
**Acceptance Criteria:**
- ✅ Dune Analytics dashboard embedded
- ✅ On-chain metrics displayed
- ✅ Public stats widget functional
...
**Acceptance Criteria:**
- ✅ Subscription tiers functional (Pro + Premium)
- ✅ Smart contract payments working
...
- ✅ Personalized feed functional
- ✅ Premium feature enforced (unlimited recommendations)
...
**Acceptance Criteria:**
- ✅ English + Chinese support working
- ✅ Language switcher functional
- ✅ UI translated (all text)
...
**Acceptance Criteria:**
- ✅ Smart contracts deployed (6 mainnets × 3 contracts = 18 deployments)
- ✅ Testnet testing complete
...
**Acceptance Criteria:**
- ✅ 10,000 DAU supported
- ✅ 100,000+ articles cached
- ✅ Virtual scrolling working
- ✅ Auto-cleanup functional (30 days)
...
- ✅ Firefox compatible
- ✅ Safari compatible (desktop + iOS)
- ✅ Mobile compatible (iOS 14+, Android 10+)
