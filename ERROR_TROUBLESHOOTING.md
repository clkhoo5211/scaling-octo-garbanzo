...
1. **Check Branch Name:**
   ...
   - Fixed: Workflow now supports both branches ✅
...
1. **Check basePath:**
   ...
   - Set via `GITHUB_REPOSITORY_NAME` env var ✅
...
1. **Check Specific Step:**
   ...
   - Typecheck errors → Fix TypeScript errors
...
2. **Look for Workflows:**
   - "Deploy to GitHub Pages" - Should show ✅ or ❌
   - "CI - Format, Typecheck and Lint" - Should show ✅ or ❌
...
2. **Common Error Patterns:**
   ...
   - `undefined` → Missing environment variable
   - `404` → Missing file or wrong path
...
1. **Check Workflow Logs:**
   - Actions → Click failed workflow → Check logs
